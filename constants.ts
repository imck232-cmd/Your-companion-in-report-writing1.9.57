...
export const INITIAL_USERS: User[] = [
    ...
    { id: 't-user-26', name: 'آية فاتق', code: '1122025', permissions: TEACHER_PERMISSIONS, managedTeacherIds: [] },
];
...
export const INITIAL_SUPERVISORY_PLAN: SupervisoryPlan = [
  ...
  { id: 'sp7', domain: 'التدريس', objective: 'التخطيط التربوي للمنهج الدراسي', indicatorText: 'تم تقديم تغذية راجعة للخطط التدريسية للمواد الدراسية لعدد 2 بنسبة 100%', indicatorCount: 2, evidence: 'نسخ الخطط', activityText: 'ورشة مراجعة الخطط', activityPlanned: 2, monthlyPlanned: { ...emptyMonthly, muharram: 1, jumada_al_ula: 1 }, executed: '', cost: '', reasonsForNonExecution: '', notes: '', status: 'قيد التنفيذ' },
